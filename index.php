...
<head>
  ...
  <title>Welcome to manavsev</title>
...
<script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.5.1/moment.min.js"></script>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/horizontal.jpeg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>जरूरतमंद को भोजन</h3>
            <p class="fst-bold">
              जन्मदिन, विवाह वर्षगांठ, बेटे-बेटी के विवाह का दिन, जलवा कार्यक्रम, आपकी कोई मानता हो, विशेष त्योहार पर, आपके परिवार के लिए कोई विशेष दिन आदि  खुशियों को राशन दान कर उनके साथ बांटिए, जिन्हे भोजन की वास्तव में जरूरत है।
          
            </p>
            <ul>
              <li><i class="bx bx-check-double"></i> आपके द्वारा दी जानेवाली भोजन-राशन-सहयोग राशि जिसमे आपका स्नेह मिला हुआ होगा, न जाने कितनों को भोजन के रूप में तृप्ति देगा।.</li>
              <li><i class="bx bx-check-double"></i> हम साथ मिलकर व सभी के सहयोग से इस सेवा भाव को अनवरत चलाए रखने हेतु ,आपसे सहयोग की अपील करते है ...</li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="assets/img/first.jpeg" class="card-img-top" alt="...">
              <div class="card-icon">
                <i class="bx bx-book-reader"></i>
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Our Mission</a></h5>
                <p class="card-text">लोगों के लिए भोजन स्वस्थ और पौष्टिक खाद्य पदार्थों, सामुदायिक शिक्षा और वकालत तक पहुंच के माध्यम से भूख को खत्म करने और हमारे समुदाय के स्वास्थ्य और कल्याण में सुधार करने के लिए काम कर रहा है। </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="assets/img/second.jpeg" class="card-img-top" alt="...">
              <div class="card-icon">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="card">
              <img src="assets/img/third.jpeg" class="card-img-top" alt="...">
              <div class="card-icon">
                <i class="bx bx-landscape"></i>
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Our Vision</a></h5>
                <p class="card-text">हम एक ऐसे समुदाय की कल्पना करते हैं जहां हर किसी के पास अच्छी गुणवत्ता, पौष्टिक भोजन तक पहुंच हो, भूख और खराब पोषण के परिणामों को समझता हो और एक मजबूत, स्वस्थ हम्बोल्ट काउंटी बनाने के लिए प्रतिबद्ध हो।. </p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="faq">
      <div class="container">
        ...
        <ul class="faq-list">
          ...
          <li>
            <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq1">दान के लिए एक तिथि कैसे बुक करें? <i class="bx bx-down-arrow-alt icon-show"></i><i class="bx bx-x icon-close"></i></a>
            <div id="faq1" class="collapse" data-bs-parent=".faq-list">
              <p>
                डोनेशन के लिए व्यू बुक स्लॉट में जाएं, फिर तारीख चुनें और फिर बुक करने के लिए बटन पर क्लिक करें और फिर फॉर्म भरें
              </p>
            </div>
          </li>
          ...
          <div class="col-lg-3 col-md-5 mb-5 mb-md-0">
            <div class="info">
              <div class="address">
                ...
                <p>मानव सेवा
                  मंगला चौक के पास
                  <br>बस स्टैंड रोड, बिलासपुर 495001</p>
              </div>
